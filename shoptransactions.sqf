...
if (shopactivescript == 1) exitwith 
{
	
	player groupchat "script already active";
	sleep 3; 
	shopactivescript = 0;
};
...
{
if (shopactivescript == 1) exitwith {player groupchat "script already active";sleep 3; shopactivescript = 0;};
shopactivescript = 1;
instock=true;
