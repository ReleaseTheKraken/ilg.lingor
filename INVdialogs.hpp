...

{
	...
	objects[] = {};
	controls[] = {Lin_ShopInfoBG,Lin_ShopInfoList, Lin_ShopInfoPic,itemliste, itemeingabe, submit, cancel, weight, cancel2, submit2, itemeingabe2, itemliste2, text_inventarMishy, dummybutton};
	//onLoad = "[_this, [44440,44441,44442]] call LinLib_OnLoad;";
	//LINNET EDIT
	class Lin_ShopInfoBG: RscBackground
	{
		idc = 44440;
		x = -0.2125;
		y = 0.25;
	...
	class Lin_ShopInfoPic: RscPicture
	{
		idc = 44441;
	...
	class Lin_ShopInfoList: RscListbox
	{
		idc = 44442;
		x = -0.2;
		y = 0.45;
...
//===Linnet Info Dialog====
...

	{
		...
		x = 0.04; y = 0.10;
		w = 0.42; h = 0.48;
		onLBSelChanged = "[(lbData [1, lbCurSel 1]), [44440,44441,44442]] call LinLib_OnSelect;";
	};
