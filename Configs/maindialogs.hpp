...
class ja_neins
{
	...
	class button1 : RscButton	
	{
		...
		text = $STRS_ja;
		action = "closedialog 0; Antworts = 1;";
	};
	...
	class button2 : RscButton	
	{
		...
		text = $STRS_nein;	
		action = "closedialog 0; Antworts = 2;";
	};
	
	class dummybutton : RscDummy {idc = 1024;
	};
};
...
class steuerdialog
{
	...
	controlsBackground[] = {DLG_BACK1, background};		
	objects[] = { };	
	controls[] = {text_itemsteuer, slider_itemsteuer, Vehiclesteuer_text, Vehiclesteuer_slider, magazinsteuer_text, magazinsteuer_slider, waffesteuer_text, waffesteuer_slider, banksteuer_text, banksteuer_slider, button_submit, button_cancel, dummybutton};	
	...
	class Vehiclesteuer_text : RscText		
	{							
		idc = 21;		
		x = 0.35;
		y = 0.23;
	...
	class Vehiclesteuer_slider : RscSliderH
	{								
		idc = 22;
		x = 0.35; 
		y = 0.28;
