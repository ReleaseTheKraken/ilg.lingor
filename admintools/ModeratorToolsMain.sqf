...
if ((getPlayerUID player) in ["234410054"]) then { //all admins
	if ((getPlayerUID player) in ["234410054"]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["234410054"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["130964934"]) then { // super admins
		adminmenu =
		[
			["",true],
