...
if (_art == "add") then 
	...
	if(_license == "oil" and !(_uid in donatorlevel1)) exitWith { player groupChat "This license is restricted to donors only, visit www.IslandLifeGaming.com for more info."};
