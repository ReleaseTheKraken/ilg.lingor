...
if (da_mando) then {
	...
	(format["server globalchat ""%1 IS USING MANDO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING MANDO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING MANDO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (da_ACE) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING ACE! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING ACE! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING ACE! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "Smaker") or !(isnil "tracker") or !(isnil "hacks") or !(isnil "igodok") or !(isnil "infammook") or !(isnil "clExec_command")) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING MORKER HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING MORKER HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING MORKER HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "Alex_DELETE_TOOL")) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING GALEX HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING GALEX HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING GALEX HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if ((da_lostkey) or !(isnil "LOKI_GUI_Key_Color")) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING LOKIS LOST HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING LOKIS LOST HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING LOKIS LOST HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (da_inkodisp) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING INKO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING INKO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING INKO! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (da_jtd) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING JTD! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING JTD! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING JTD! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;	
...
if (da_slx) then {
	hackerjustloggedin = true;
	publicvariable "hackerjustloggedin";
	(format["server globalchat ""%1 IS USING SLX! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING SLX! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING SLX! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;	
...
if ((da_LEA) or !(isnil "LEA_Lock") or !(isnil "LEA_Lock") or !(isnil "enable_lea_addon") or !(isnil "LEA_Action")) then
{
	...
	(format["server globalchat ""%1 IS USING LEA HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING LEA HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING LEA HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "Logan__RE") or !(isnil "Scott_Joplin") or !(isnil "Lpiano") or !(isnil "LcMinorScale") or !(isnil "LoganNZLlovesCMDmenus") or !(isnil "mainworldmenu") or !(isnil "ambientsoundmenu") or !(isnil "loganssaymenu")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING NLZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING NLZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING NLZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "hacks") or !(isnil "pic") or !(isnil "firstrun") or !(isnil "frezok") or !(isnil "freze")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING ZEUS HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING ZEUS HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING ZEUS HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "HMDIR") or !(isnil "MENUTITLE") or !(isnil "img") or !(isnil "firstRun") or !(isnil "Advanced Menu") or !(isnil "Reset Advanced Menu") or !(isnil "Remove Scroll Options")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING DAYZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING DAYZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING DAYZ HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "scroll_m_init_star") or !(isnil "startmenu_star") or !(isnil "anotherpage") or !(isnil "Dayz_GUI_R") or !(isnil "r_player_unconscious") or !(isnil "r_player_timeout") or !(isnil "keybindings") or !(isnil "keypress") or !(isnil "thfile") or !(isnil "pic") or !(isnil "hanger_is_a_bitching_dickhead") or !(isnil "norrnRACarUp") or !(isnil "Metallica_infiSTAR_hax_toggled") or !(isnil "Metallica_infiSTAR_funcs_inited")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING INFISTAR HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING INFISTAR HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING INFISTAR HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "tracker") or !(isnil "pic") or !(isnil "hacks") or !(isnil "Called")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING WUAT HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING WUAT HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING WUAT HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!(isnil "jmsgtext") or !(isnil "jmsgtype") or !(isnil "jmsgtimeout") or !(isnil "jplname") or !(isnil "jexecstring") or !(isnil "bDisaUSInpu") or !(isnil "cpLoopsDelay")) then
{
	...
	publicVariable "CheatInfo";
	hintC "NICE TRY MOTHERFUCKER!";
	(format["server globalchat ""%1 IS USING DARKY HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING DARKY HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
	sleep 0.2;
	(format["server globalchat ""%1 IS USING DARKY HACKS! REPORT TO A MEMBER OF STAFF IMMIDIETLY!: ILG.TS3DNS.COM"";", name player]) call broadcast;
...
if (!naughty) exitWith {
	player sidechat "Welcome To Island Life Gaming!";
};