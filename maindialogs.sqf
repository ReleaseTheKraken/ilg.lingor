...
if (_art == "spielerliste") then 
{
	...
	lbAdd [1, (format ["Street Reputation:  %1", streetrep])];
...
if (_art == "steuern") then 
{
	...
	while {ctrlVisible 1032} do 
	{
		...
		ctrlSetText [21, format[localize "STRS_dialogandere_steuerdialog_Vehiclesteuer", ((round(sliderPosition 22)) call ISSE_str_IntToStr)]];
