...
_shopnum      = gundealer1 call INV_getshopnum;
...
if(_stock >= _maxstock)exitwith{player groupchat "the shop has reached its maximum stock for this weapon";sleep 1;fvspam=false;};

['Mishy', _preis] call INV_AddInventoryItem;
